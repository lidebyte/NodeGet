...
impl From<&DynamicMonitoringData> for DynamicMonitoringSummaryData {
    fn from(data: &DynamicMonitoringData) -> Self {
        ...
        Self {
            ...
            time: data.time,
            cpu_usage: Some(data.cpu.total_cpu_usage as f32),
            ...
            load_one: Some(data.load.one as f32),
            load_five: Some(data.load.five as f32),
            load_fifteen: Some(data.load.fifteen as f32),
