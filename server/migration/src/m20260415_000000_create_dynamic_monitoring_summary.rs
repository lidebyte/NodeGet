        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(float_null(DynamicMonitoringSummary::CpuUsage))
                    ...
                    .col(float_null(DynamicMonitoringSummary::LoadOne))
                    .col(float_null(DynamicMonitoringSummary::LoadFive))
                    .col(float_null(DynamicMonitoringSummary::LoadFifteen))
